========================================================================
    ACTIVE TEMPLATE LIBRARY : WMSVisual Project Overview
========================================================================

AppWizard has created this WMSVisual project for you to use as the starting point for
...
WMSVisual.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (WMSVisual.h)
        GUID definitions                                (WMSVisual_i.c)
        A type library                                  (WMSVisual.tlb)
        Marshaling code                                 (WMSVisual_p.c and dlldata.c)

WMSVisual.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in WMSVisual.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named WMSVisual.pch and a precompiled types file named StdAfx.obj.
...
WMSVisualps.vcxproj
	...
	dlldata.c, WMSVisual_i.c and WMSVisual_p.c which are required
	to build the proxy/stub DLL.

WMSVisualps.vcxproj.filters
