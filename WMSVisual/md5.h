...
// methods for controlled operation:
  ...
  void  update     (unsigned char *input, DWORD input_length);
...
// methods to acquire finalized result
  ...
  friend std::ostream&   operator<< (std::ostream&, MD5 context);
	...
	typedef DWORD uint4; // assumes integer is 4 words long
	typedef WORD uint2; // assumes short integer is 2 words long
